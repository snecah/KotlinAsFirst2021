 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = PI / 180 * (deg + min / 60.0 + sec / 3600.0)
 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = 60 * (hoursArrive - hoursDepart) - minutesDepart + minutesArrive
